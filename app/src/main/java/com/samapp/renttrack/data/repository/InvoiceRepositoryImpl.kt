...
class InvoiceRepositoryImpl(private val context: Context) : InvoiceRepository {
    ...
    override suspend fun generateInvoice(tenant: Tenant,amount: String, rentDate: String): File? {
        ...
        canvas.drawText("This is a computer-generated receipt and does not require any signature/stamp.", 100f, 570f, paint)

        pdfDocument.finishPage(page)

        val file = File(context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS), "RentInvoice.pdf")
        try {
            ...
            e.printStackTrace()
            Log.e("InvoiceRepository", "Error generating PDF: ${e.message}")
        }
        return null
    }
